...
export class Venta {
   ...
   constructor(private router: Router) { }
    ...
    mockPropiedades = {      
      ...
      data: [
        { rowno: 1, titulo: 'Casa en venta en los agaves', tipo: 'Venta', precio:'$11,800', habitaciones:'3 Habitaciones', bat:'2 baños', desc:'Casa en renta en los agaves residencial 3 habitaciones 2 baños y medio Terracita Planta baja Sala Sala Comedor Cocina Bodeguita Patio de lavado Renta mensual 11,700 incluye mantenimiento.', img:'https://res.cloudinary.com/drz6acdcg/image/upload/v1756958502/1_1077b85d1b.png' },
        { rowno: 2, titulo: 'Casa en venta en Brisas del Lago', tipo: 'Venta', precio:'$8,800', habitaciones:'3 Habitaciones', bat:'2 baños', desc:'Casa en renta en Brisas del Lago residencial 3 habitaciones 2 baños y medio Terracita Planta baja Sala Sala Comedor Cocina Bodeguita Patio de lavado Renta mensual 8,700 incluye mantenimiento.', img:'https://res.cloudinary.com/drz6acdcg/image/upload/v1756958502/1_1077b85d1b.png'  },
