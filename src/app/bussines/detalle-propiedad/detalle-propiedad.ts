...
export class DetallePropiedad {
  ...
  ngOnInit(): void {
    //this.stepper = new Stepper(document.querySelector('.bs-stepper')! as HTMLElement);
    
// ...
     /*this.http.get('assets/datos.txt').subscribe((data: any) => {
    console.log(data); // El JSON ya parseado
    });*/  
